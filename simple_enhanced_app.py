...
from demo.simple_enhanced_ui import create_enhanced_ui
...
if __name__ == "__main__":
    argparser = argparse.ArgumentParser(description="HivisionIDPhoto - AI智能证件照制作工具 (增强版)")
    ...
    print("🚀 启动增强版HivisionIDPhoto...")
    print("✨ 包含SEO优化、隐私保护、功能特色展示等增强功能")
