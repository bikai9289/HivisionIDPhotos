...
- 在线体验： [![Spaces](https://img.shields.io/badge/🤗-Open%20in%20Spaces-blue)](https://huggingface.co/spaces/TheEeeeLin/AI IDPhotos)、[![][modelscope-shield]][modelscope-link]、[![][modelers-shield]][modelers-link]、[![][compshare-shield]][compshare-link]
...
- 2024.09.17: Gradio Demo增加**自定义底色-HEX输入**功能 | **（社区贡献）C++版本** - [AI IDPhotos-cpp](https://github.com/zjkhahah/AI IDPhotos-cpp) 贡献 by [zjkhahah](https://github.com/zjkhahah)
...
AI IDPhoto 旨在开发一种实用、系统性的证件照智能制作算法。
...
如果 AI IDPhoto 对你有帮助，请 star 这个 repo 或推荐给你的朋友，解决证件照应急制作问题！

<br>

# 🏠 社区

我们分享了一些由社区构建的AI IDPhotos的有趣应用和扩展：

| [AI IDPhotos-ComfyUI][community-hivision-comfyui] | [AI IDPhotos-wechat-weapp][community-hivision-wechat] |
| :----------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------: |
| <a href="https://github.com/AIFSH/AI IDPhotos-ComfyUI"> <img src="assets/comfyui.png" width="900" alt="ComfyUI workflow"> </a>  | <a href="https://github.com/no1xuan/AI IDPhotos-wechat-weapp"> <img src="assets/community-wechat-miniprogram.png" width="900" alt="ComfyUI workflow"> </a>  |
|ComfyUI证件照处理工作流 | 证件照微信小程序（JAVA后端+原生前端） |

| [AI IDPhotos-Uniapp][community-hivision-uniapp] | [AI IDPhotos-web](https://github.com/jkm199/AI IDPhotos-web)|
| :------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------: |
| <a href="https://github.com/soulerror/AI IDPhotos-Uniapp"> <img src="assets/community-uniapp-wechat-miniprogram.png" width="900" alt="AI IDPhotos-uniapp"> </a>  | <a href="https://github.com/jkm199/AI IDPhotos-web"> <img src="assets/community-web.png" width="900" alt="AI IDPhotos-uniapp"> </a>  |
| 证件照微信小程序（uniapp）| 证件照应用网页版 |


- [AI IDPhotos-cpp](https://github.com/zjkhahah/AI IDPhotos-cpp): AI IDPhotos C++版本，由 [zjkhahah](https://github.com/zjkhahah) 构建
- [ai-idphoto](https://github.com/wmlcjj/ai-idphoto): [AI IDPhotos-wechat-weapp](https://github.com/no1xuan/AI IDPhotos-wechat-weapp) 的uniapp多端兼容版，由 [wmlcjj](https://github.com/wmlcjj) 贡献
- [AI IDPhotos-uniapp-WeChat-gpto1](https://github.com/jkm199/AI IDPhotos-uniapp-WeChat-gpto1/): 由gpt-o1辅助完成开发的证件照微信小程序，由 [jkm199](https://github.com/jkm199) 贡献
- [AI IDPhotos-windows-GUI](https://github.com/zhaoyun0071/AI IDPhotos-windows-GUI)：Windows客户端应用，由 [zhaoyun0071](https://github.com/zhaoyun0071) 构建
- [AI IDPhotos-NAS](https://github.com/ONG-Leo/AI IDPhotos-NAS): 群晖NAS部署中文教程，由 [ONG-Leo](https://github.com/ONG-Leo) 贡献
...
| 人像抠图模型 | 介绍 | 下载 |
| -- | -- | -- |
| MODNet | [MODNet](https://github.com/ZHKKKe/MODNet)官方权重 | [下载](https://github.com/Zeyi-Lin/AI IDPhotos/releases/download/pretrained-model/modnet_photographic_portrait_matting.onnx)(24.7MB)|
| hivision_modnet | 对纯色换底适配性更好的抠图模型 | [下载](https://github.com/Zeyi-Lin/AI IDPhotos/releases/download/pretrained-model/hivision_modnet.onnx)(24.7MB) |
...
> 如果下载网速不顺利：前往[SwanHub](https://swanhub.co/ZeYiLin/AI IDPhotos_models/tree/main)下载。
...
| RetinaFace | **离线**人脸检测模型，CPU推理速度中等（秒级），精度较高| [下载](https://github.com/Zeyi-Lin/AI IDPhotos/releases/download/pretrained-model/retinaface-resnet50.onnx)后放到`hivision/creator/retinaface/weights`目录下 |
...
```bibtex
@misc{aiidphotos,
      title={{AI IDPhotos: A Lightweight and Efficient AI ID Photos Tool}},
      author={Zeyi Lin and SwanLab Team},
      year={2024},
      publisher={GitHub},
      url = {\url{https://github.com/Zeyi-Lin/AI IDPhotos}},
}
```
...
<!-- 社区项目链接 -->
[community-hivision-comfyui]: https://github.com/AIFSH/AI IDPhotos-ComfyUI
[community-hivision-wechat]: https://github.com/no1xuan/AI IDPhotos-wechat-weapp
[community-hivision-uniapp]: https://github.com/soulerror/AI IDPhotos-Uniapp
