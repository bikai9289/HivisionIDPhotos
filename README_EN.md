...
- 2024.09.17: Gradio Demo adds **Custom Background Color-HEX Input** feature | **(Community Contribution) C++ Version** - [AI IDPhotos-cpp](https://github.com/zjkhahah/AI IDPhotos-cpp) contributed by [zjkhahah](https://github.com/zjkhahah)
...
AI IDPhoto aims to develop a practical and systematic intelligent algorithm for producing ID photos.
...
If AI IDPhoto helps you, please star this repo or recommend it to your friends to solve the urgent ID photo production problem!

<br>

# 🏠 Community

We have shared some interesting applications and extensions of AI IDPhotos built by the community:

- [AI IDPhotos-ComfyUI](https://github.com/AIFSH/AI IDPhotos-ComfyUI): ComfyUI ID photo processing workflow built by [AIFSH](https://github.com/AIFSH/AI IDPhotos-ComfyUI) 

[<img src="assets/comfyui.png" width="900" alt="ComfyUI workflow">](https://github.com/AIFSH/AI IDPhotos-ComfyUI)

- [AI IDPhotos-wechat-weapp](https://github.com/no1xuan/AI IDPhotos-wechat-weapp): WeChat ID photo mini program, powered by the AI IDPhotos algorithm, contributed by [no1xuan](https://github.com/no1xuan)
...
- [AI IDPhotos-Uniapp](https://github.com/soulerror/AI IDPhotos-Uniapp): Front-end of WeChat ID photo mini program based on uniapp, powered by the AI IDPhotos algorithm, contributed by [soulerror](https://github.com/soulerror)
...
- [AI IDPhotos-cpp](https://github.com/zjkhahah/AI IDPhotos-cpp): C++ version of AI IDPhotos, built by [zjkhahah](https://github.com/zjkhahah)
- [AI IDPhotos-windows-GUI](https://github.com/zhaoyun0071/AI IDPhotos-windows-GUI): Windows client application built by [zhaoyun0071](https://github.com/zhaoyun0071)
- [AI IDPhotos-NAS](https://github.com/ONG-Leo/AI IDPhotos-NAS): Chinese tutorial for Synology NAS deployment, contributed by [ONG-Leo](https://github.com/ONG-Leo)
...
- `modnet_photographic_portrait_matting.onnx` (24.7MB): Official weights of [MODNet](https://github.com/ZHKKKe/MODNet), [download](https://github.com/Zeyi-Lin/AI IDPhotos/releases/download/pretrained-model/modnet_photographic_portrait_matting.onnx)
- `hivision_modnet.onnx` (24.7MB): Matting model with better adaptability for pure color background replacement, [download](https://github.com/Zeyi-Lin/AI IDPhotos/releases/download/pretrained-model/hivision_modnet.onnx)
...
| RetinaFace | **Offline** face detection model, moderate CPU inference speed (in seconds), and high accuracy | [Download](https://github.com/Zeyi-Lin/AI IDPhotos/releases/download/pretrained-model/retinaface-resnet50.onnx) and place it in the `hivision/creator/retinaface/weights` directory |
